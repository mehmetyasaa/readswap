...
import 'package:readswap/book_details.dart'; // Ensure this import is correct
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(child: Text('Henüz beğenilen ürün yok.', style: TextStyle(fontSize: 18)));
          }
                    ...
                    confirmDismiss: (direction) async {
                      return await showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: Text('Bu ürünü beğenilenler listesinden silmek istiyor musunuz?'),
                          actions: [
                            TextButton(
